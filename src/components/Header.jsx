...
const Header = () => {
  ...
  return (
    <>
      <header className=" sticky top-0 left-0 bg-slate-50/60 z-50 border-b border-slate-100 py-5">
        <div className="absolute flex items-center top-0 p-3 h-full 2xl:hidden">
          <img
        ...
        <div className=" flex flex-1 flex-col sm:flex-row justify-evenly items-center    ">
          <div>
      ...
      <div
        className={`fixed left-0 z-40 w-full h-3/6 ${
          dropDown ? "block" : "hidden"
        } bg-slate-100 transition-all`}
      >
        <div className="flex flex-col items-center justify-center text-3xl font-light space-y-4 mt-5">
          <Link to="\">Recipes</Link>
          <Link to="\">Menu foods</Link>
          <Link to="\">Wines</Link>
          <Link to="\">Make from fridge</Link>
          <Link to="\">Meal plan</Link>
          <Link to="\">Food videos</Link>
        </div>
      </div>
    </>
  );
